...
BitCoinCash, beloved of our friend from Newport, was at risk at end of last year, and there was a successful attack on Ethereum Classic (an Ethereum fork) was successfully attacked in January.
